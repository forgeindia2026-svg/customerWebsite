...
export default function Products() {
  ...
  const handleAddProduct = (e) => {
    ...
    const dbProduct = {
      ...
      delivery: productForm.delivery || 'Free Delivery',
      ...
      .then(data => {
        if (data.success && data.data) {
          ...
          dispatch(addProduct({
            ...
            delivery: item.delivery || productForm.delivery || 'Free Delivery',
            warranty: item.warranty || productForm.warranty || '1 Year Warranty',
            rating: item.rating || 4.5,
            offers: item.badge || '',
