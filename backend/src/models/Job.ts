...
export type JobStatus = 'PENDING' | 'WAITING_FOR_TECH' | 'ASSIGNMENT_PENDING_ACCEPTANCE' | 'ASSIGNED' | 'IN_PROGRESS' | 'WAITING_ADMIN_APPROVAL' | 'COMPLETED' | 'APPROVED' | 'CANCELLED';
...
const JobSchema: Schema = new Schema(
  {
    ...
    status: {
      type: String,
      enum: ['PENDING', 'WAITING_FOR_TECH', 'ASSIGNMENT_PENDING_ACCEPTANCE', 'ASSIGNED', 'IN_PROGRESS', 'BEFORE_PHOTOS_DONE', 'AFTER_PHOTOS_DONE', 'INSPECTED', 'DAILY_REPORTED', 'WAITING_ADMIN_APPROVAL', 'COMPLETED', 'APPROVED', 'CANCELLED'],
      default: 'PENDING',
    },
    priority: {
      type: String,
